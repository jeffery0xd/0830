...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-white shadow-sm w-64 hidden md:block fixed top-0 h-screen overflow-y-auto">
      <div className="p-6">
        <nav className="mt-4">
          <ul className="space-y-1 fixed top-0 h-screen overflow-y-auto">
            {menuItems.map((item) => (
              <li key={item.id}>
                <a
                  href="#"
